...
// ============================================
// Spawn Bee (BEGINNER - Static Position)
// ============================================
function spawnBall() {
  // BEGINNER MODE: Random position on screen, no movement
  ball.x = Math.random() * (canvas.width - 100) + 50;
  ball.y = Math.random() * (canvas.height - 100) + 50;
  
  // No velocity - bee is static
  ball.vx = 0;
  ball.vy = 0;
 ...
 // ============================================
 // Bee Movement: BEGINNER - No Movement (Static)
 // ============================================

function updateBallMovement(dt) {
  // BEGINNER MODE: Bee doesn't move, just stays in place
  // No velocity updates needed
 }
...
// ============================================
  ...
  async function calculateConsistency(newTimeTaken) {
    ...
    // Get last 4 games from BEGINNER level only
