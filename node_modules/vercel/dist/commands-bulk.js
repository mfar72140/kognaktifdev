...
import {
  ...
  webhooksCommand,
  whoamiCommand
} from "./chunks/chunk-27NYBHVQ.js";
import "./chunks/chunk-L3DHDLSP.js";
import {
  metricsCommand,
  schemaSubcommand
} from "./chunks/chunk-2HEZ6WYK.js";
...
async function fetchMarketplaceIntegrations(client, slug, teamId) {
  const searchParams = new URLSearchParams();
  searchParams.set("view", "account");
  searchParams.set("installationType", "marketplace");
...
async function getFirstConfiguration(client, integrationSlug, teamId) {
...
async function getBalanceInstallationId(client, integrationSlug, teamId, telemetry2) {
  let knownIntegrationSlug = false;
...
async function main9(client) {
  ...
  const {
    ...
    subcommandOriginal,
    args: subArgs
  } = getSubcommand3(args.slice(1), COMMAND_CONFIG13);
  const needHelp = flags["--help"];
  function printHelp(command) {
    output_manager_default.print(
      help(command, {
...
async function metrics(client) {
  ...
  switch (subcommand) {
    case "schema": {
      ...
      const schemaFn = (await import("./chunks/schema-3XF2GWU3.js")).default;
    ...
    default: {
      ...
      const queryFn = (await import("./chunks/query-MMUKRX4T.js")).default;
...
function formatRedirectsTable(redirects, actionSymbol) {
  const rows = redirects.map((redirect) => {
    ...
    const colorFn = actionSymbol === "+" ? import_chalk86.default.green : actionSymbol === "-" ? import_chalk86.default.red : (s) => s;
    return [
...
async function rollingRelease(client) {
  ...
  const {
    ...
    args: subcommandArgs,
    subcommandOriginal
  } = getSubcommand3(client.argv.slice(3), COMMAND_CONFIG19);
